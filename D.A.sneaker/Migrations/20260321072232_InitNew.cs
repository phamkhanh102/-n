        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserChatStates_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Running shoes", "Running" },
                    { 2, "Casual sneakers", "Casual" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "Name", "Password", "Role", "Status", "Username" },
                values: new object[] { 999, new DateTime(2026, 3, 21, 14, 22, 32, 17, DateTimeKind.Local).AddTicks(5567), "admin@gmail.com", "Admin", "$2a$11$FvYfpa3OcDPgDIczONvBhujFx4c4SEZbGfiwYwPUMH4qVpmZeB1hK", "Admin", true, null });
